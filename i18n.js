...
const STRINGS = {
  en: {
    app: "Clay Journal",
    "tab.costs": "Costs", "costs.materials": "Materials", "costs.pieces": "Pieces",
    "f.shape": "Shape", "shape.box": "Box", "shape.mug": "Mug", "shape.bowl": "Bowl", "shape.plate": "Plate",
    "shape.vase": "Vase", "shape.irregular": "Irregular", "shape.new": "New shape…", "confirm.removeShape": "Delete the shape \"{name}\"? Pieces using it fall back to length, width and height.",
    "shape.askName": "What is this shape called?", "shape.askFields": "Which measurements? Separate with commas, e.g. widest, narrowest, height",
    "dim.l": "L", "dim.w": "W", "dim.h": "Height", "dim.dia": "Diameter", "dim.mouth": "Mouth", "dim.long": "Longest", "dim.short": "Shortest", "dim.depth": "Depth",
    "f.dimsThrown": "As thrown", "f.dimsTrimmed": "After trimming", "f.weightThrown": "Weight (g)",
    "buy.new": "New order", "buy.order": "Order", "buy.store": "Shop", "buy.items": "What was on it", "buy.addItem": "Add another",
    "buy.delivery": "Delivery", "buy.orderTotal": "Order total", "buy.deliveryNote": "Delivery is shared across the order, in proportion to what each thing cost.", "buy.kind": "What did you buy", "buy.clay": "Clay", "buy.glaze": "Glaze",
    "buy.name": "Which one", "buy.amount": "Amount (g)", "buy.cost": "What it cost", "buy.rate": "Works out at {rate} per kg",
    "buy.none": "Nothing bought yet. Log an order — bags of clay, tubs of glaze, the delivery fee — and every piece gets costed automatically.",
    "buy.stock": "{n} bought · {rate}/kg",
    "cost.title": "Cost", "cost.clay": "Clay", "cost.glaze": "Glaze", "cost.firing": "Firing", "cost.travel": "Travel",
    "cost.other": "Other", "cost.otherNote": "What for", "cost.total": "Cost to make", "cost.profit": "Profit",
    "cost.perPiece": "Shared across {n} pieces", "cost.noRate": "Add a purchase of this material to cost it",
    "cost.glazeUsed": "Glaze used (g)", "cost.spent": "Spent on materials", "cost.made": "Pieces made", "cost.sold": "Sold", "cost.forSale": "For sale",
    "fire.where": "Where", "fire.home": "Home kiln", "fire.studio": "Communal kiln", "fire.studioName": "Studio",
    "fire.fee": "Firing fee", "fire.travel": "Travel cost", "fire.sent": "Date sent", "fire.collected": "Date collected",
    "fire.all": "All", "fire.addStudio": "Add a studio…",
    "tab.design": "Design", "tab.more": "More", "tab.pieces": "Pieces", "tab.firings": "Firings", "tab.ideas": "Design", "tab.settings": "Settings",
    "btn.newPiece": "New piece", "btn.newFiring": "New firing", "btn.newDesign": "New design", "btn.newInsp": "New inspiration",
    "btn.addPhoto": "Add photo", "btn.takePhoto": "Take photo", "btn.addRow": "Add clay", "btn.delete": "Delete", "btn.done": "Done", "confirm.removeTag": "Remove \"{name}\" from the list? Pieces already using it keep it.",
    ...
    "confirm.deleteDesign": "Delete this design?", "confirm.deleteInsp": "Delete this inspiration?", "confirm.deletePurchase": "Delete this order? Piece costs will be recalculated.", "confirm.deletePhoto": "Delete this photo?",
    ...
    "empty.match": "Nothing matches that.", "f.titles": "Names under photos", "f.layout": "Layout",
    ...
    "stage.wet": "Greenware", "stage.bisque": "Bisque", "stage.glazed": "Glazed", "stage.final": "Final",
  ...
  zh: {
    app: "陶记",
    "tab.costs": "成本", "costs.materials": "材料", "costs.pieces": "作品",
    "f.shape": "器型", "shape.box": "方形", "shape.mug": "马克杯", "shape.bowl": "碗", "shape.plate": "盘",
    "shape.vase": "花瓶", "shape.irregular": "异形", "shape.new": "新建器型…", "confirm.removeShape": "删除器型「{name}」？用它的作品会回到长宽高。",
    "shape.askName": "这个器型叫什么？", "shape.askFields": "要记录哪些尺寸？用逗号分开，例如：最宽、最窄、高",
    "dim.l": "长", "dim.w": "宽", "dim.h": "高", "dim.dia": "口径", "dim.mouth": "瓶口", "dim.long": "最长", "dim.short": "最短", "dim.depth": "深",
    "f.dimsThrown": "拉坯后", "f.dimsTrimmed": "修坯后", "f.weightThrown": "重量（克）",
    "buy.new": "新增订单", "buy.order": "订单", "buy.store": "店铺", "buy.items": "订单内容", "buy.addItem": "再加一项",
    "buy.delivery": "运费", "buy.orderTotal": "订单合计", "buy.deliveryNote": "运费按各项金额的比例分摊到订单里的材料。", "buy.kind": "买了什么", "buy.clay": "泥料", "buy.glaze": "釉料",
    "buy.name": "具体是哪种", "buy.amount": "数量（克）", "buy.cost": "花了多少",
    "buy.rate": "合 {rate} / 公斤",
    "buy.none": "还没有采购记录。记一笔订单（泥、釉、运费），每件作品的成本就会自动算出来。",
    "buy.stock": "已购 {n} · {rate}/公斤",
    "cost.title": "成本", "cost.clay": "泥料", "cost.glaze": "釉料", "cost.firing": "烧制", "cost.travel": "交通",
    "cost.other": "其他", "cost.otherNote": "用途", "cost.total": "制作成本", "cost.profit": "利润",
    "cost.perPiece": "由 {n} 件作品分摊", "cost.noRate": "记一笔该材料的采购，才能算出成本",
    "cost.glazeUsed": "用釉量（克）", "cost.spent": "材料支出", "cost.made": "作品成本", "cost.sold": "已售出", "cost.forSale": "出售中",
    "fire.where": "地点", "fire.home": "自家窑", "fire.studio": "公共窑", "fire.studioName": "工作室",
    "fire.fee": "烧制费", "fire.travel": "交通费", "fire.sent": "送去日期", "fire.collected": "取回日期",
    "fire.all": "全部", "fire.addStudio": "添加工作室…",
    "tab.design": "设计", "tab.more": "更多", "tab.pieces": "作品", "tab.firings": "烧制", "tab.ideas": "设计", "tab.settings": "设置",
    "btn.newPiece": "新作品", "btn.newFiring": "新烧制", "btn.newDesign": "新设计", "btn.newInsp": "新灵感",
    "btn.addPhoto": "添加照片", "btn.takePhoto": "拍照", "btn.addRow": "添加泥料", "btn.delete": "删除", "btn.done": "完成", "confirm.removeTag": "把「{name}」从列表里删掉？已经用了它的作品不受影响。",
    ...
    "confirm.deleteDesign": "删除这个设计？", "confirm.deleteInsp": "删除这条灵感？", "confirm.deletePurchase": "删除这笔订单？作品成本会重新计算。", "confirm.deletePhoto": "删除这张照片？",
    untitled: "未命名", search: "搜索", none: "无", newFiringOpt: "+ 新建烧制", optional: "可选",
    "empty.pieces": "还没有作品。下次拉坯结束后点「新作品」。",
    "empty.match": "没有符合条件的内容。", "f.titles": "照片下方显示名称", "f.layout": "显示方式",
    ...
    "stage.wet": "泥坯", "stage.bisque": "素烧", "stage.glazed": "已上釉", "stage.final": "成品",
