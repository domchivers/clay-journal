...
const STRINGS = {
  en: {
    ...
    "buy.new": "New purchase", "buy.kind": "What did you buy", "buy.clay": "Clay", "buy.glaze": "Glaze",
    "buy.name": "Which one", "buy.amount": "Amount (g)", "buy.cost": "What it cost", "buy.rate": "Works out at {rate} per kg",
    "buy.none": "Nothing bought yet. Add a bag of clay or a tub of glaze and every piece gets costed automatically.",
    ...
    "confirm.deleteDesign": "Delete this design?", "confirm.deleteInsp": "Delete this inspiration?", "confirm.deletePurchase": "Delete this purchase? Piece costs will be recalculated.", "confirm.deletePhoto": "Delete this photo?",
  ...
  zh: {
    ...
    "buy.new": "新增采购", "buy.kind": "买了什么", "buy.clay": "泥料", "buy.glaze": "釉料",
    "buy.name": "具体是哪种", "buy.amount": "数量（克）", "buy.cost": "花了多少",
    "buy.rate": "合 {rate} / 公斤",
    "buy.none": "还没有采购记录。记一袋泥或一桶釉，每件作品的成本就会自动算出来。",
    ...
    "confirm.deleteDesign": "删除这个设计？", "confirm.deleteInsp": "删除这条灵感？", "confirm.deletePurchase": "删除这笔采购？作品成本会重新计算。", "confirm.deletePhoto": "删除这张照片？",
