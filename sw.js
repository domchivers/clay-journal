...
const CACHE = "clay-v12";
const ASSETS = ["./", "./index.html", "./styles.css?v=12", "./i18n.js?v=12", "./supabase-config.js?v=12", "./cloud.js?v=12", "./store.js?v=12", "./app.js?v=12", "./manifest.webmanifest", "./icons/icon-192.png?v=1", "./icons/icon-180.png?v=1"];
const SLOW_MS = 4000;
