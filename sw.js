...
const CACHE = "clay-v13";
const ASSETS = ["./", "./index.html", "./styles.css?v=13", "./i18n.js?v=13", "./supabase-config.js?v=13", "./cloud.js?v=13", "./store.js?v=13", "./app.js?v=13", "./manifest.webmanifest", "./icons/icon-192.png?v=1", "./icons/icon-180.png?v=1"];
const SLOW_MS = 4000;
