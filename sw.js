...
const CACHE = "clay-v4";
const ASSETS = ["./", "./index.html", "./styles.css?v=4", "./i18n.js?v=4", "./supabase-config.js?v=4", "./cloud.js?v=4", "./store.js?v=4", "./app.js?v=4", "./manifest.webmanifest", "./icons/icon-192.png?v=1", "./icons/icon-180.png?v=1"];
const SLOW_MS = 4000;
