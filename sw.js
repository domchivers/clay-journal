...
const CACHE = "clay-v7";
const ASSETS = ["./", "./index.html", "./styles.css?v=7", "./i18n.js?v=7", "./supabase-config.js?v=7", "./cloud.js?v=7", "./store.js?v=7", "./app.js?v=7", "./manifest.webmanifest", "./icons/icon-192.png?v=1", "./icons/icon-180.png?v=1"];
const SLOW_MS = 4000;
