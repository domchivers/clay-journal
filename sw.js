...
const CACHE = "clay-v6";
const ASSETS = ["./", "./index.html", "./styles.css?v=6", "./i18n.js?v=6", "./supabase-config.js?v=6", "./cloud.js?v=6", "./store.js?v=6", "./app.js?v=6", "./manifest.webmanifest", "./icons/icon-192.png?v=1", "./icons/icon-180.png?v=1"];
const SLOW_MS = 4000;
