...
const CACHE = "clay-v9";
const ASSETS = ["./", "./index.html", "./styles.css?v=9", "./i18n.js?v=9", "./supabase-config.js?v=9", "./cloud.js?v=9", "./store.js?v=9", "./app.js?v=9", "./manifest.webmanifest", "./icons/icon-192.png?v=1", "./icons/icon-180.png?v=1"];
const SLOW_MS = 4000;
