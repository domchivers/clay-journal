...
const CACHE = "clay-v5";
const ASSETS = ["./", "./index.html", "./styles.css?v=5", "./i18n.js?v=5", "./supabase-config.js?v=5", "./cloud.js?v=5", "./store.js?v=5", "./app.js?v=5", "./manifest.webmanifest", "./icons/icon-192.png?v=1", "./icons/icon-180.png?v=1"];
const SLOW_MS = 4000;
