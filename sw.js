...
const CACHE = "clay-v8";
const ASSETS = ["./", "./index.html", "./styles.css?v=8", "./i18n.js?v=8", "./supabase-config.js?v=8", "./cloud.js?v=8", "./store.js?v=8", "./app.js?v=8", "./manifest.webmanifest", "./icons/icon-192.png?v=1", "./icons/icon-180.png?v=1"];
const SLOW_MS = 4000;
