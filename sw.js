...
const CACHE = "clay-v20";
const ASSETS = ["./", "./index.html", "./styles.css?v=20", "./i18n.js?v=20", "./supabase-config.js?v=20", "./cloud.js?v=20", "./store.js?v=20", "./app.js?v=20", "./manifest.webmanifest", "./icons/icon-192.png?v=1", "./icons/icon-180.png?v=1"];
const SLOW_MS = 4000;
